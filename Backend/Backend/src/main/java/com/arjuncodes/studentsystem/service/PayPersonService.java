...
public interface PayPersonService {
    ...
    void calculateFinalPay(PayPerson payPerson);
    // Method to calculate tax based on salary, deductions, and rebate
    BigDecimal calculateTax(BigDecimal salary, BigDecimal deductions, BigDecimal rebate);
