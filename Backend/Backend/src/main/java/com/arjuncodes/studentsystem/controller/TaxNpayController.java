...
public class TaxNpayController {
    ...
    public ResponseEntity<Double> calculateTax(
        ...
        try {
            ...
            BigDecimal deductionsBigDecimal = BigDecimal.valueOf(deductions);
            BigDecimal rebateBigDecimal = BigDecimal.valueOf(rebate);
            double tax = payPersonService.calculateTax(salaryBigDecimal, deductionsBigDecimal, rebateBigDecimal).doubleValue();
